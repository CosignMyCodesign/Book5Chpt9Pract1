    ...
    render() {
        return (
            <React.Fragment>
                ...
                {/* chapter 9 insertion for login route */}
                <Route path="/login" component={Login} />
                
                {/* Old path without authentication */}
                ...
                {/* Chapter 9 new route for authentication */}
                <Route exact path="/animals" render={props => {
                ...
                <Route exact path="/owners" render={props => {
                    if (this.isAuthenticated()) {
                        return <OwnerList {...props} removeOwner={this.removeOwner}
                          owners={this.state.owners} />
                    } else {
                        return <Redirect to="/login" />
                    }
                ...
                {/* Chapter 8 insertion to add new _____ */}
